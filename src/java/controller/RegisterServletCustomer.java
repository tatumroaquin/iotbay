...
public class RegisterServletCustomer extends HttpServlet {
        ...
        if (!validator.validateEmail(email)) {
            ...
            try {
                ...
                if(customer != null) {
                    ...
                    manager.createCustomer(email, password, mobile, firstName, lastName, street, city, state, postCode, country);
                ...
                Logger.getLogger(RegisterServletCustomer.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
}
